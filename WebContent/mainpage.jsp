...
<div class="header">
	<div class="logo">
		<h2 class="style">Car Search for CS5200</h2>
...
<div class="wrapper">
	...
	<div class="content_left">
		<div class="text1-nav">
		<ul>
			<li class="active"><a href="details.jsp">Start Searching</a></li>
	    </ul>
	</div>
	 <div class="search1">
	 	 	<h2>Login Successfully!</h2>
	<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
			<form action="/finalproject/homepage.jsp" method="post">
			<h2 class="style">Welcome Dear <%=(String)session.getAttribute("myusername")%></h2>
			<input type="submit" value="Your Connection" name="submit" class="submit" />
			</form>	
	<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
	...
	<div class="content_right">
			 <div class="gallery">
			 	<h2>Welcome to Car Comparison for CS5200!</h2>
...
<div class="wrapper">
	<div class="footer">
		<div class="copy">
				<p class="w3-link">Car Search Project CS5200 </p>
		</div>
